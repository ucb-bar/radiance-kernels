...
//   M = batch of decode steps (or heads) = 32.
//
...
//
// The tile is NON-SQUARE (TILE_M=32, TILE_N=128). The stock mxgemm_lib only
...
//
// This variant is fixed at M=32 (fp8); the committed `data` carries that shape.
