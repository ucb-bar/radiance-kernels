// fp4 down-proj READ-ONCE: one TM=256 x TN=64 tile, each weight byte DMA'd from DRAM once.
...
constexpr GemmConfig CFG{ .TILE_M=256, .TILE_N=64, .TILE_K=64, .DATATYPE=GemmDatatype::FP4, .QUANT_OUTPUT=false };
